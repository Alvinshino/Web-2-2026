    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            if (empty($nombre)) {
                ...
                echo json_encode(["error" => "Falta el nombre de la pelicula"]);
                exit();
            }
            ...
            if ($stmt->execute()) {
                ...
                echo json_encode(["message" => "boleto creado", "id" => $id, "nombre" => $nombre, "edad" => $edad]);
            } else {
                http_response_code(500);
        ...
        case 'PUT':
            ...
            if ($stmt->execute()) {
                http_response_code(200);
                echo json_encode(["message" => "boleto actualizado", "id" => $id, "nombre" => $nombre, "edad" => $edad]);
            } else {
                http_response_code(500);
                echo json_encode(["error" => "Error al actualizar el boleto"]);
            }
            $stmt->close();
            break;
